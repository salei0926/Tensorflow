...
from face_recognition.load_data import load_dataset,resize_image, IMAGE_SIZE
class Dataset:
...
class Model:
        ...
        def build_model(self, dataset, nb_classes = 2):
              ...
              self.model.add(Conv2D(32, (3, 3), padding="same",input_shape = dataset.input_shape)) #1 2维卷积层
              ...
              self.model.summary()
        # 训练模型
        def train(self, dataset, batch_size = 20, epochs = 10, data_augmentation = True):
...
if __name__ == '__main__':
    dataset = Dataset('C:\\Users\\16522\\Desktop\\photo\\data')
    dataset.load()
...
if __name__ == '__main__':
        ...
        model.build_model(dataset)
        model.train(dataset)
        model.save_model(file_path='C:\\Users\\16522\\Desktop\\photo\\data\\zl.face.model.h5')
if __name__ == '__main__':
        dataset = Dataset('C:\\Users\\16522\\Desktop\\photo\\data')
        dataset.load()
        ...
        # 评估模型
        model = Model()
        model.load_model(file_path='C:\\Users\\16522\\Desktop\\photo\\data\\zl.face.model.h5')
